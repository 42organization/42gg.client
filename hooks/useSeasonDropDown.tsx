...
export default function useModeToggle(clickTitle?: boolean, intraId?: string | string[] | undefined) {
	...
	return {seasonList, season, seasonDropDownHandler, seasonMode, TitleSeasonHandler};
}