...
const CoinIcon = () => (
	<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 194 120">
		<defs>
		<symbol viewBox="0 0 194 120" id="icon-coin">
			<g>
				<g>
					<path fill="#FDF377" d="M188.5 43.2C185.4 23.3 145.6 7.6 97 7.6 46.4 7.6 5.3 24.7 5.3 45.7c0 0 0 20.3 0 28.6 0 21 41.1 38.1 91.7 38.1s91.7-17.1 91.7-38.1c0-9.2 0-31 0-31C188.6 43.3 188.6 43.3 188.5 43.2z"/>
				</g>
			</g>
			<path fill="none" stroke="#000000" strokeWidth="0.5" strokeMiterlimit="10" d="M97 60"/>
			<g>
