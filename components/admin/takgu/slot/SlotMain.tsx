...
import { CurrentMatch, EditedSchedule } from 'types/admin/takgu/adminSlotTypes';
import { instance, instanceInManage } from 'utils/axios';
import { toastState } from 'utils/recoil/toast';
import SlotCurrent from 'components/admin/takgu/slot/SlotCurrent';
import SlotPreview from 'components/admin/takgu/slot/SlotPreview';
import styles from 'styles/admin/takgu/slot/SlotMain.module.scss';
