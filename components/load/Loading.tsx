        ...
        <div className={styles.spinner}>
          ...
          <svg className={[styles.raquet, styles.r1].join(' ')}>
            ...
            <ellipse
              ...
              ry='50'
            />
            <ellipse className={styles.back} cx='40' cy='50' rx='35' ry='50' />
            <rect
          ...
          <svg className={styles.shadow}>
            <ellipse className={styles.sr_1} cx='70' cy='30' rx='50' ry='15' />
            <ellipse className={styles.sb} cx='150' cy='30' rx='15' ry='4.5' />
            <ellipse className={styles.sr_2} cx='230' cy='30' rx='50' ry='15' />
          </svg>
        </div>
      </div>
    </div>
