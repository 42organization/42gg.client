...
const coinTrans1: ICoinHistory = {
  history: '출석',
  amount: 1,
  createdAt: new Date('2023-08-07 15:57:25'),
};

const coinTrans2: ICoinHistory = {
  history: '일반게임 참가',
  amount: 3,
  createdAt: new Date('2023-08-06 15:57:25'),
};
...
const coinTrans4: ICoinHistory = {
  history: '랭크게임 승리',
  amount: 5,
  createdAt: new Date('2023-03-31 00:30:25'),
};
...
const coinTrans6: ICoinHistory = {
  history: '출석',
  amount: 1,
  createdAt: new Date('2023-03-25 00:30:25'),
};

const coinTrans7: ICoinHistory = {
  history: '출석',
  amount: 1,
  createdAt: new Date('2023-03-22 00:30:25'),
};
...
const coinTrans9: ICoinHistory = {
  history: '출석',
  amount: 1,
  createdAt: new Date('2023-03-11 00:30:25'),
};

const coinTrans10: ICoinHistory = {
  history: '출석',
  amount: 1,
  createdAt: new Date('2023-03-01 00:30:25'),
};
